    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal className='relative'>
        <DropdownMenu.Content
          className='text-md absolute right-[-70px] sm:right-[-10px] py-3 w-[250px] rounded-md shadow-[0px_5px_38px_-10px_rgba(33,_36,_39,_0.33),_0px_10px_20px_-15px_rgba(33,_36,_39,_0.33)] border-2 bg-artemis-white border-artemis-black will-change-[opacity,transform] data-[side=top]:animate-slideDownAndFade data-[side=right]:animate-slideLeftAndFade data-[side=bottom]:animate-slideUpAndFade data-[side=left]:animate-slideRightAndFade z-50 overflow-y-auto max-h-[300px] sm:max-h-max'
          sideOffset={10}
          alignOffset={20}>
